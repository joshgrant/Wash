...
open class StateMachine<State>: Codable where State: Hashable & Codable
{
    ...
    @objc public func observeStateChangeRequest(_ notification: Notification)
    {
    ...
    public func postStateChangeNotification(state: State)
    {
    ...
    public func postStateChangeFailedNotification(failedState: State)
    {
        NotificationCenter.default.post(
